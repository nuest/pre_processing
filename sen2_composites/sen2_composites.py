...
def create_composites(imgfolder, Level = '2A'):
    ...
    # when directly run from command line, check whether composites should be created from L2A or L1C images
    # when run as imported module in another script, Level can be set by that script but is not required
